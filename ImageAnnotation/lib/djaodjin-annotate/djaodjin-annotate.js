    ...
    Annotate.prototype = {
        init: function() {
            ...
            if (self.options.bootstrap) {
                self.$tool = $("<div id=\"tool\">" + "<button id=\"undoaction\" title=\"Undo the last annotation\"" + " class=\"btn btn-primary " + classPosition2 + " annotate-undo\">" + "<i class=\"glyphicon glyphicon-arrow-left\"></i></button>" + "<div class=\"" + classPosition1 + "\" data-toggle=\"buttons\">" + "<label class=\"btn btn-primary active\">" + "<input type=\"radio\" name=\"" + self.toolOptionId + "\" data-tool=\"rectangle\"" + " data-toggle=\"tooltip\" data-placement=\"top\"" + " title=\"Draw an rectangle\"><i class=\"glyphicon glyphicon-unchecked\"></i>" + "</label>" + "<label class=\"btn btn-primary\">" + "<input type=\"radio\" name=\"" + self.toolOptionId + "\" data-tool=\"circle\"" + " data-toggle=\"tooltip\" data-placement=\"top\" title=\"Write some text\">" + "<i class=\"glyphicon glyphicon-copyright-mark\"></i>" + "</label>" + "<label class=\"btn btn-primary\">" + "<input type=\"radio\" name=\"" + self.toolOptionId + "\" data-tool=\"text\"" + " data-toggle=\"tooltip\" data-placement=\"top\" title=\"Write some text\">" + "<i class=\"glyphicon glyphicon-font\"></i>" + "</label>" + "<label class=\"btn btn-primary\">" + "<input type=\"radio\" name=\"" + self.toolOptionId + "\" data-tool=\"arrow\"" + " data-toggle=\"tooltip\" data-placement=\"top\" title=\"Draw an arrow\">" + "<i class=\"glyphicon glyphicon-arrow-up\"></i>" + "</label>" + "<label class=\"btn btn-primary\">" + "<input type=\"radio\" name=\"" + self.toolOptionId + "\" data-tool=\"pen\"" + " data-toggle=\"tooltip\" data-placement=\"top\" title=\"Pen Tool\">" + "<i class=\"glyphicon glyphicon-pencil\"></i>" + "</label>" + "</div>" + "<button type=\"button\" id=\"redoaction\"" + " title=\"Redo the last undone annotation\"" + "class=\"btn btn-primary " + classPosition2 + " annotate-redo\">" + "<i class=\"glyphicon glyphicon-arrow-right\"></i></button>" + "</div>");
        ...
        saveImage: function() {
            var self = this;
            self.href = self.exportImage();
            self.download = 'img.jpg';
        },
